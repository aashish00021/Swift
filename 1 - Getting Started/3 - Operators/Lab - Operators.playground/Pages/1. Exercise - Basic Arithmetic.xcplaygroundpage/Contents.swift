...
let remainder1 = even / 2
let remainder2 = odd / 2
print(remainder1)
print(remainder2)

print("if the number id divisible by 2 competely and leaves remainder 0 then its even else its odd")
/*:
